...
public class DetailScrollInfoView {
    ...
    private void onInitScrollInfoView() {
        if (mDetailActivityReference != null && mDetailActivityReference.get() != null) {
            final DetailFullDescActivity mDetailFullDescActivity = (DetailFullDescActivity) mDetailActivityReference
                    .get();
            ...
            mBlitzBridgeSurfaceView = (BlitzBridgeSurfaceView) mDetailFullDescActivity.findViewById(R.id.detail_fulldesc_webview_blitz);
