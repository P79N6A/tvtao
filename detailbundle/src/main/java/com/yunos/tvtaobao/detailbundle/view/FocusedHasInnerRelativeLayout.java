...
public class FocusedHasInnerRelativeLayout extends DetailCommentTabView implements FocusListener {

    protected final String TAG = "FocusedItemRelativeLayout";
    ...
    public FocusedHasInnerRelativeLayout(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public FocusedHasInnerRelativeLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public FocusedHasInnerRelativeLayout(Context context) {
        super(context);
    }
