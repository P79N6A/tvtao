...
public class TmallResConfig extends AbstractResConfig {
    ...
    public Drawable getBuyIcon() {
        if (isGreenStatus) {
            return mContext.getResources().getDrawable(R.drawable.ytsdk_ui2_detail_tmall_icon_green);
        } else if (canBuy) {
            return mContext.getResources().getDrawable(R.drawable.ytsdk_ui2_detail_tmall_icon);
        } else {
            return mContext.getResources().getDrawable(R.drawable.ytsdk_ui2_detail_tmall_icon_gray);
        }
    }
    ...
    public Drawable getBuyBgIcon() {
        ...
        if (isGreenStatus) {
            return mContext.getResources().getDrawable(R.drawable.ytsdk_ui2_detail_tmall_button_green);
        } else if (canBuy) {
            return mContext.getResources().getDrawable(R.drawable.ytsdk_ui2_detail_tmall_button);
        } else {
            return mContext.getResources().getDrawable(R.drawable.ytsdk_ui2_detail_tmall_button_gray);
        }
    }
    ...
    public Drawable getBuyBgFocusIcon() {
        if (isGreenStatus) {
            ...
            return mContext.getResources().getDrawable(R.drawable.ytsdk_ui2_detail_tmall_focus);
        } else {
            return mContext.getResources().getDrawable(R.drawable.ytsdk_ui2_detail_tmall_button_gray);
        }
    ...
    public Drawable getScrollIcon() {
        ...
        return mContext.getResources().getDrawable(R.drawable.ytsdk_ui2_detail_tmall_scrollbar);
    }

    @Override
    public Drawable getButtonSelectedDraw() {

        return mContext.getResources().getDrawable(R.drawable.ytsdk_ui2_detail_tmall_button_focus);
    }
    ...
    public Drawable getCartFocusIcon() {
        ...
        return mContext.getResources().getDrawable(R.drawable.ytsdk_ui2_detail_tmall_cart_focus);
    }
    ...
    public Drawable getScanCodeFocusIcon() {
        ...
        return mContext.getResources().getDrawable(R.drawable.ytsdk_ui2_detail_tmall_scan_code_focus);
    }

    @Override
    public Drawable getQRCodeIcon() {

        return mContext.getResources().getDrawable(R.drawable.ytm_qr_code_icon_tmail);
    }
    ...
    public Drawable getFavFocusIcon() {
        ...
        return mContext.getResources().getDrawable(R.drawable.ytsdk_ui2_detail_tmall_collect_focus);
    }
    ...
    public Drawable getShopIndexFocusIcon() {
        ...
        return mContext.getResources().getDrawable(R.drawable.ytsdk_ui2_detail_tmall_shop_focus);
    }

    @Override
    public ColorStateList getFontColor() {

        return mContext.getResources().getColorStateList(R.color.ytm_tmall_red);
    }

    @Override
    public Drawable getRelevantSelectDraw() {

        return mContext.getResources().getDrawable(R.drawable.ytsdk_ui2_detail_tmall_relevant_focus);
    }
    ...
    public Drawable getCommentItemSelectDraw() {
        ...
        return mContext.getResources().getDrawable(R.drawable.ytsdk_ui2_detail_tmall_word_bg);
    }

    @Override
    public Drawable getEvaluateFocusDraw() {

        return mContext.getResources().getDrawable(R.drawable.ytsdk_detail_tmall_button_focus_shape);
    }
