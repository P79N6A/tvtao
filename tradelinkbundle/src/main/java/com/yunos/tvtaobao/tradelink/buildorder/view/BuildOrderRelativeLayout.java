...
public class BuildOrderRelativeLayout extends RelativeLayout implements ItemListener {

    public BuildOrderRelativeLayout(Context context) {
        super(context);
    }

    public BuildOrderRelativeLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public BuildOrderRelativeLayout(Context context, AttributeSet attrs, int defStyle) {
