...
public class DialogFocusLeftRightPositionManager extends FocusPositionManager {
    ...
    private void changeBtnSelectStatus() {
        ...
        if (mCurSelect == CUR_SELECT.POSITIVE_BTN) {
            ...
            mPositiveButton.setBackgroundResource(R.drawable.gradient_dialog_right_focus);
            ...
            mNegativeButton.setBackgroundResource(R.drawable.gradient_dialog_left_focus);
        }
    }
}
