...
//        initAttr(context, attrs);
    ...
    public boolean dispatchKeyEvent(KeyEvent event) {
        ...
        Log.i(TAG, "dispatchKeyEvent result="+result);
        View focusView = this.getFocusedChild();
        if (focusView == null) {
            Log.i(TAG, "dispatchKeyEvent rtn="+result);
            return result;
        } else {
            ...
            if (event.getAction() == KeyEvent.ACTION_UP) {
                Log.i(TAG, "dispatchKeyEvent rtn="+true);
                return true;
            } else {
                switch (event.getKeyCode()) {
                    ...
                    case KeyEvent.KEYCODE_DPAD_UP:
                        ...
                        if (mOnKeyListener != null) {
                            mOnKeyListener.onKeyEvent("up", upView == null);
                        }
                        if (event.getAction() == KeyEvent.ACTION_UP) {
                            Log.i(TAG, "dispatchKeyEvent rtn="+true);
                            return true;
                            ...
                            if (upView != null) {
                                ...
                                if(mItemUpFocusView != null){
                                    mItemUpFocusView.requestFocus();
                                }else {
                                    this.smoothScrollBy(0, -dy);
                                }
                                Log.i(TAG, "dispatchKeyEvent rtn="+true);
    ...
    /**
     * 手动设置recyclerview item 上方的可聚焦view
     * */
    public void setUpFoucsView(View view){
        mItemUpFocusView = view;
    }
    ...
    public interface OnKeyListener {
        ...
        void onKeyEvent(String direction, boolean isNull);
