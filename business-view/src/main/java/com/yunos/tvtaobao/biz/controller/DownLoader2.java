...
public class DownLoader2 {
    ...
    public DownLoader2(String source, String target, String mD5, String version, long size, long sleepTime,
                       Context context, int type, Handler myHandler) {
    ...
    public void download() throws Exception {
        ...
        oldVersion = sp.getString(UpdatePreference.SP_KEY_VERSION, "");
