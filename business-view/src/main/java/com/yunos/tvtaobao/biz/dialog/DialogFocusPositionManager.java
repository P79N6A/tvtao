...
public class DialogFocusPositionManager extends FocusPositionManager {
    ...
    private void changeBtnSelectStatus() {
        ...
        if (mCurSelect == CUR_SELECT.POSITIVE_BTN) {
            mPositiveButton.setTextColor(getResources().getColor(R.color.ytbv_white));
            mPositiveButton.setBackgroundColor(getResources().getColor(R.color.ytbv_button_focus));
            mNegativeButton.setTextColor(getResources().getColor(R.color.ytbv_unfocus_text_color));
            mNegativeButton.setBackgroundColor(getResources().getColor(android.R.color.transparent));
        } else {
            mPositiveButton.setTextColor(getResources().getColor(R.color.ytbv_unfocus_text_color));
            mPositiveButton.setBackgroundColor(getResources().getColor(android.R.color.transparent));
            mNegativeButton.setTextColor(getResources().getColor(R.color.ytbv_white));
            mNegativeButton.setBackgroundColor(getResources().getColor(R.color.ytbv_button_focus));
        }
    }
}
