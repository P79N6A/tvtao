...
public class ItemLayoutForCoupon extends FrameLayout implements ItemListener {

    private DrawRect mDrawRect;

    public ItemLayoutForCoupon(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init();
    }

    public ItemLayoutForCoupon(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public ItemLayoutForCoupon(Context context) {
        super(context);
        init();
    }
