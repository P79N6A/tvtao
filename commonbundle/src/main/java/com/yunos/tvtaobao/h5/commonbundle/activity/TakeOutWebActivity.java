...
public class TakeOutWebActivity extends TaoBaoBlitzActivity {
...
//    private TvTaoBaoZtcPlugin mZtcPlugin;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        onKeepActivityOnlyOne(TakeOutWebActivity.class.getName());
...
//            mZtcPlugin = new TvTaoBaoZtcPlugin(new WeakReference<TaoBaoBlitzActivity>(this));
    ...
    protected void onDestroy() {
        super.onDestroy();
        onRemoveKeepedActivity(TakeOutWebActivity.class.getName());
        //Util.currentPage = null;
