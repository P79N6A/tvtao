...
public class FocusFinder {
    ...
    public final View findNextFocus(ViewGroup root, View focused, int direction) {
        ...
        if (focused != null) {
            ...
            if (mRoot == null) {
                mRoot = (ViewGroup) root.getRootView();
                //				mSequentialFocusComparator.setRoot((ViewGroup) root.getRootView());
            }

            // fill in interesting rect from focused
            //			mSequentialFocusComparator.getRect(focused, mFocusedRect);
            //			 focused.getFocusedRect(mFocusedRect);
            mFocusedRect.set(getRect(focused));
            //			 mRoot.offsetDescendantRectToMyCoords(focused, mFocusedRect);
        } else {
    ...
    Rect getRect(View focused) {
        ...
        rect.set(focused.getLeft(), focused.getTop(), focused.getRight(), focused.getBottom());
    ...
    private View findNextFocus(ViewGroup root, View focused, Rect focusedRect, int direction) {
        ...
        //
        // if (direction == View.FOCUS_FORWARD || direction ==
        // View.FOCUS_BACKWARD) {
