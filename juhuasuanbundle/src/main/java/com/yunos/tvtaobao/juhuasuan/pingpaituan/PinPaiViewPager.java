...
public class PinPaiViewPager extends ViewGroup {

    private static final String TAG = "PinPaiViewPager";
    ...
    public PinPaiViewPager(Context context) {
        super(context);
        initViewPager();
    }

    public PinPaiViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViewPager();
    }
    ...
    void initViewPager() {
        ...
        mPageGap = PingPaiDimension.PAGEVIEW_GAP;
        mPageWidth = PingPaiDimension.PAGE_WIDTH;
    ...
    void setCurrentItemInternal(int item, boolean smoothScroll, boolean always, int velocity) {
        ...
        int pagewidth = mPageWidth == 0 ? getWidth() : (mPageWidth + mPageGap);

        final int destX = pagewidth * item;
    ...
    private void recomputeScrollPosition(int width, int oldWidth, int margin, int oldMargin) {
        ...
        final int widthWithMargin = mPageWidth;
        if (oldWidth > 0) {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        //        final int width = r-l;
        final int width = mPageWidth + mPageGap;
