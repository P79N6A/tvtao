...
public class SdkViewPager extends ViewGroup {
    ...
    void initViewPager() {
        ...
        mPageWidth = VisualMarkConfig.PAGE_WIDTH + VisualMarkConfig.PAGEVIEW_GAP;
    ...
    void setCurrentItemInternal(int item, boolean smoothScroll, boolean always, int velocity) {
        ...
        int pagewidth = mPageWidth == 0 ? getWidth() : mPageWidth;
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        //        final int width = r-l;
        final int width = VisualMarkConfig.PAGE_WIDTH + VisualMarkConfig.PAGEVIEW_GAP;
