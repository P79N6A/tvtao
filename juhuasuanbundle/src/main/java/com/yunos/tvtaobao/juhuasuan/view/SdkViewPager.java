...
public class SdkViewPager extends ViewGroup {
    ...
    void initViewPager() {
        ...
        mPageWidth[0] = PAGE_WIDTH[0];
        mPageWidth[1] = PAGE_WIDTH[1];
    ...
    void setCurrentItemInternal(int item, boolean smoothScroll, boolean always, int velocity) {
        ...
        int pagewidth = mPageWidth[mCurItem == 1 ? 0 : 1] == 0 ? getWidth() : mPageWidth[mCurItem == 1 ? 0 : 1];
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (child.getVisibility() != GONE && (ii = infoForChild(child)) != null) {
                int loff = (mPageWidth[ii.position == 1 ? 0 : 1] + mPageMargin + (PAGEVIEW_GAP[ii.position == 1 ? 0 : 1] / 2))
                        * ii.position;
                AppDebug.i("===>", "pagewidth>>>>>>> : " + loff + ",pos : " + ii.position);
                int childLeft = getPaddingLeft() + loff;
                int childTop = getPaddingTop();
                AppDebug.i(TAG, "Positioning #" + i + " " + child + " f=" + ii.object + ":" + childLeft + ","
        ...
        if (!mScroller.isFinished()) {
            if (mScroller.computeScrollOffset()) {
                ...
                if (mOnPageChangeListener != null) {
                    ...
                    int pagewidth = mPageWidth[mCurItem == 1 ? 0 : 1] == 0 ? getWidth() : mPageWidth[mCurItem == 1 ? 0
                            : 1];
