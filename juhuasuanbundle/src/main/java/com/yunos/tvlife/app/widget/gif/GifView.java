...
public class GifView extends ImageView implements GifAction {
	...
	private final int DRAW_BITMAP = 101;
	private final int START_DECODE = 102;
	private final int DRAW_FIRST_IMAGE = 103;
...
//		super.onDraw(canvas);
//		if (this.mMaskPath != null && getDrawable() != null) {
//			Drawable maiDrawable = getDrawable();
//			Paint paint = ((BitmapDrawable) maiDrawable).getPaint();
