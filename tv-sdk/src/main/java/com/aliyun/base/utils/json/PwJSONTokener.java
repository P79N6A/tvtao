 ...
 *         + "}";
 *
 * PwJSONObject object = (PwJSONObject) new JSONTokener(json).nextValue();
 * String query = object.getString("query");
 * PwJSONArray locations = object.getPwJSONArray("locations");</pre>
 *
...
public class PwJSONTokener {
     ...
     *     called.
     */
    public PwJSONTokener(String in) {
        this.in = in;
    }
     ...
     *
     * @return a {@link PwJSONObject}, {@link PwJSONArray}, String, Boolean,
     *     Integer, Long, Double or {@link PwJSONObject#NULL}.
     ...
     */
    private PwJSONObject readObject() throws JSONException {
        PwJSONObject result = new PwJSONObject();
     ...
     */
    private PwJSONArray readArray() throws JSONException {
        PwJSONArray result = new PwJSONArray();
