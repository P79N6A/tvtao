...
public class NinePatchHelper {
	...
	public static Drawable process(Drawable d) {
		Drawable nd = d;
	...
	public static Drawable process(Bitmap b) {
		Drawable nd = null;
	...
	private static boolean isNinePatch(Bitmap b) {
		boolean result = true;
	...
	private static Bitmap cropNinePatch(Bitmap b) {
		Bitmap cb = null;
	...
	static byte[] createChunk(Bitmap b) {
		byte[] chunk = null;
		...
		int size = 32 + // wasDeserialized, numXDivs, numYDivs, numColors,
	...
	private static int toInt(byte[] a, int offset) {
		int i = 0;
	...
	private static void toBytes(byte[] a, int offset, int v) {
