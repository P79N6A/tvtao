 ...
 * <p>
 * See {@link ListView}, {@link GridView}, {@link Spinner} and {@link Gallery} for commonly used subclasses of
 * AdapterView.
...
public abstract class AdapterView<T extends Adapter> extends ViewGroup {
    ...
    protected static final int TUI_TEXT_COLOR_GREY = 0xFF999999;

    protected static final int TUI_TEXT_COLOR_WHITE = 0xFFFFFFFF;

    protected static final int TUI_TEXT_SIZE_2 = 24;//sp
    ...
    public boolean performItemClick(View view, int position, long id) {
        Log.i(TAG, TAG + ".performItemClick.view = " + view + ".positon = " + position + ".id = " + id);
     ...
     * @return the position within the adapter's data set of the view, or {@link #INVALID_POSITION} if the view does not
     *         correspond to a list item (or it is not currently visible).
     */
