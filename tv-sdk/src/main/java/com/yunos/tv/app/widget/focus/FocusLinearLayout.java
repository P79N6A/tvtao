...
public class FocusLinearLayout extends LinearLayout implements DeepListener, ItemListener {
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        Log.d(TAG, "onKeyDown keyCode = " + keyCode + ", mDeep = " + mDeep);
    ...
    protected void doFocusChanged(boolean gainFocus, int direction, Rect previouslyFocusedRect) {
        if (gainFocus) {
            ...
            Log.i(TAG, TAG + ".doFocusChanged.getSelectedView = " + getSelectedView());
    ...
    public ItemListener getItem() {
        View v = getSelectedView();
        if (DEBUG) {
            Log.i(TAG, TAG + ".getItem.getSelectedView = " + getSelectedView() + ".mDeep = " + mDeep + ".mLastDeep = "
    ...
    public Params getParams() {
        if (DEBUG) {
            Log.i(TAG, TAG + ".getParams.mDeep = " + mDeep);
        }
        if (mDeep != null) {
