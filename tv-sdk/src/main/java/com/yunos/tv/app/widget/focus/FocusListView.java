...
public class FocusListView extends ListView implements DeepListener, ItemListener {
    ...
    protected boolean moveUp() {
        ...
        int nextSelectedPosition = getNextSelectedPosition(FOCUS_UP);
        if (mDeepMode) {
        ...
        if (nextSelectedPosition != INVALID_POSITION) {
            ...
            if (mDeepMode) {
                ...
                Rect focusRect = null;
                if (mDeep != null) {
                    focusRect = new Rect(mDeep.getFocusParams().focusRect());
                    mDeep.onFocusDeeped(false, FOCUS_UP, null);
                }
                mDeep = null;
                ...
                if (deep != null && deep.canDeep()) {
                    ...
                    mDeep.onFocusDeeped(true, FOCUS_UP, focusRect);
                }
            }
    ...
    public int getNextSelectedPosition(int direction) {
        boolean isDown = direction == FOCUS_DOWN;
        int nextSelectedPosition = lookForSelectablePosition(getSelectedItemPosition() + (isDown ? 1 : -1), isDown);
        return nextSelectedPosition >= 0 ? nextSelectedPosition : INVALID_POSITION;
    }

    protected boolean moveDown() {
        //		int nextSelectedPosition = getSelectedItemPosition() + 1 < mItemCount ? getSelectedItemPosition() + 1 : INVALID_POSITION;
        int nextSelectedPosition = getNextSelectedPosition(FOCUS_DOWN);
        if (mDeepMode) {
            if (getChildAt(nextSelectedPosition - getFirstPosition()) == null) {
                return true;
            }
        ...
        if (nextSelectedPosition != INVALID_POSITION) {
            ...
            if (mDeepMode) {
                ...
                if (mDeep != null) {
                    focusRect = new Rect(mDeep.getFocusParams().focusRect());
                    mDeep.onFocusDeeped(false, FOCUS_DOWN, null);
                }
                mDeep = null;
                DeepListener deep = (DeepListener) getSelectedView();
                if (deep != null && deep.canDeep()) {
                    ...
                    if (focusRect != null && lastSelectView != null) {
                        ...
                        View descendant = lastSelectView;
                    ...
                    mDeep.onFocusDeeped(true, FOCUS_DOWN, focusRect);
                }
            }
    ...
    public boolean preOnKeyDown(int keyCode, KeyEvent event) {
        ...
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_MOVE_HOME:
                return getNextSelectedPosition(FOCUS_UP) != INVALID_POSITION ? true : false;
            case KeyEvent.KEYCODE_DPAD_DOWN:
            case KeyEvent.KEYCODE_PAGE_DOWN:
            case KeyEvent.KEYCODE_MOVE_END:
                return getNextSelectedPosition(FOCUS_DOWN) != INVALID_POSITION ? true : false;
