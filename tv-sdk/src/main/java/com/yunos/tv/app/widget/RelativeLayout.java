...
import com.yunos.tv.app.widget.utils.Pools;
...
public class RelativeLayout extends ViewGroup {
    ...
    private void initFromAttributes(Context context, AttributeSet attrs) {
        TypedArray a = context.obtainStyledAttributes(attrs, 
        		ReflectUtils.getInternalIntArray("com.android.internal.R$styleable", "RelativeLayout")
        		/*R.styleable.RelativeLayout*/);
        mIgnoreGravity = a.getResourceId(ReflectUtils.getInternalInt("com.android.internal.R$styleable", "RelativeLayout_ignoreGravity")
        		/*R.styleable.RelativeLayout_ignoreGravity*/, View.NO_ID);
        mGravity = a.getInt(ReflectUtils.getInternalInt("com.android.internal.R$styleable","RelativeLayout_gravity")
        		/*R.styleable.RelativeLayout_gravity*/, mGravity);
        a.recycle();
    }
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        final boolean isWrapContentWidth = widthMode != View.MeasureSpec.EXACTLY;
        final boolean isWrapContentHeight = heightMode != View.MeasureSpec.EXACTLY;
    ...
    private void measureChildHorizontal(View child, LayoutParams params, int myWidth, int myHeight) {
        ...
        if (params.width == LayoutParams.MATCH_PARENT) {
            childHeightMeasureSpec = View.MeasureSpec.makeMeasureSpec(myHeight, View.MeasureSpec.EXACTLY);
        } else {
            childHeightMeasureSpec = View.MeasureSpec.makeMeasureSpec(myHeight, View.MeasureSpec.AT_MOST);
        }
        child.measure(childWidthMeasureSpec, childHeightMeasureSpec);
    }
    ...
    boolean isLayoutRtlByReflect() {
		try {
			return (Boolean)ReflectUtils.invokeMethod(this, "isLayoutRtl", new Object[0]);
		} catch (Exception e) {
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            TypedArray a = c.obtainStyledAttributes(attrs,
            		ReflectUtils.getInternalIntArray("com.android.internal.R$styleable", "RelativeLayout_Layout")
            ...
            for (int i = 0; i < N; i++) {
                ...
                //switch (attr) {
                    /*case*/ if(attr == ReflectUtils.getInternalInt("com.android.internal.R$styleable", "RelativeLayout_Layout_layout_alignWithParentIfMissing") 
                    /*com.android.internal.R.styleable.RelativeLayout_Layout_layout_alignWithParentIfMissing:*/){
                        alignWithParent = a.getBoolean(attr, false);
                        } /*break;*/
                    /*case*/ else if(attr == ReflectUtils.getInternalInt("com.android.internal.R$styleable", "RelativeLayout_Layout_layout_toLeftOf")
                    /*com.android.internal.R.styleable.RelativeLayout_Layout_layout_toLeftOf:*/){
                        rules[LEFT_OF] = a.getResourceId(attr, 0);
                        } /*break;*/
                    /*case*/ else if(attr == ReflectUtils.getInternalInt("com.android.internal.R$styleable", "RelativeLayout_Layout_layout_toRightOf")
                    /*com.android.internal.R.styleable.RelativeLayout_Layout_layout_toRightOf:*/){
                        rules[RIGHT_OF] = a.getResourceId(attr, 0);
                        } /*break;*/
                    /*case*/ else if(attr == ReflectUtils.getInternalInt("com.android.internal.R$styleable", "RelativeLayout_Layout_layout_above")
                    /*com.android.internal.R.styleable.RelativeLayout_Layout_layout_above:*/){
                        rules[ABOVE] = a.getResourceId(attr, 0);
                        } /*break;*/
                    /*case*/ else if(attr == ReflectUtils.getInternalInt("com.android.internal.R$styleable", "RelativeLayout_Layout_layout_below")
                    /*com.android.internal.R.styleable.RelativeLayout_Layout_layout_below:*/){
                        rules[BELOW] = a.getResourceId(attr, 0);
                        } /*break;*/
                    /*case*/ else if(attr == ReflectUtils.getInternalInt("com.android.internal.R$styleable", "RelativeLayout_Layout_layout_alignBaseline")
                    /*com.android.internal.R.styleable.RelativeLayout_Layout_layout_alignBaseline:*/){
                        rules[ALIGN_BASELINE] = a.getResourceId(attr, 0);
                        } /*break;*/
                    /*case*/ else if(attr == ReflectUtils.getInternalInt("com.android.internal.R$styleable", "RelativeLayout_Layout_layout_alignLeft")
                    /*com.android.internal.R.styleable.RelativeLayout_Layout_layout_alignLeft:*/){
                        rules[ALIGN_LEFT] = a.getResourceId(attr, 0);
                        } /*break;*/
                    /*case*/ else if(attr == ReflectUtils.getInternalInt("com.android.internal.R$styleable", "RelativeLayout_Layout_layout_alignTop")
                    /*com.android.internal.R.styleable.RelativeLayout_Layout_layout_alignTop:*/){
                        rules[ALIGN_TOP] = a.getResourceId(attr, 0);
                        } /*break;*/
                    /*case*/ else if(attr == ReflectUtils.getInternalInt("com.android.internal.R$styleable", "RelativeLayout_Layout_layout_alignRight")
                    /*com.android.internal.R.styleable.RelativeLayout_Layout_layout_alignRight:*/){
                        rules[ALIGN_RIGHT] = a.getResourceId(attr, 0);
                        } /*break;*/
                    /*case*/ else if(attr == ReflectUtils.getInternalInt("com.android.internal.R$styleable", "RelativeLayout_Layout_layout_alignBottom")
                    /*com.android.internal.R.styleable.RelativeLayout_Layout_layout_alignBottom:*/){
                        rules[ALIGN_BOTTOM] = a.getResourceId(attr, 0);
                        } /*break;*/
                    /*case*/ else if(attr == ReflectUtils.getInternalInt("com.android.internal.R$styleable", "RelativeLayout_Layout_layout_alignParentLeft")
                    ...
                    /*case*/ else if(attr == ReflectUtils.getInternalInt("com.android.internal.R$styleable", "RelativeLayout_Layout_layout_alignParentTop")
                    /*com.android.internal.R.styleable.RelativeLayout_Layout_layout_alignParentTop:*/){
                        rules[ALIGN_PARENT_TOP] = a.getBoolean(attr, false) ? TRUE : 0;
                        } /*break;*/
                    /*case*/ else if(attr == ReflectUtils.getInternalInt("com.android.internal.R$styleable", "RelativeLayout_Layout_layout_alignParentRight")
                    /*com.android.internal.R.styleable.RelativeLayout_Layout_layout_alignParentRight:*/){
                        rules[ALIGN_PARENT_RIGHT] = a.getBoolean(attr, false) ? TRUE : 0;
                        } /*break;*/
                    /*case*/ else if(attr == ReflectUtils.getInternalInt("com.android.internal.R$styleable", "RelativeLayout_Layout_layout_alignParentBottom")
                    ...
                    /*case*/ else if(attr == ReflectUtils.getInternalInt("com.android.internal.R$styleable", "RelativeLayout_Layout_layout_centerInParent")
                    /*com.android.internal.R.styleable.RelativeLayout_Layout_layout_centerInParent:*/){
                        rules[CENTER_IN_PARENT] = a.getBoolean(attr, false) ? TRUE : 0;
                        } /*break;*/
                    /*case*/ else if(attr == ReflectUtils.getInternalInt("com.android.internal.R$styleable", "RelativeLayout_Layout_layout_centerHorizontal")
                    /*com.android.internal.R.styleable.RelativeLayout_Layout_layout_centerHorizontal:*/){
                        rules[CENTER_HORIZONTAL] = a.getBoolean(attr, false) ? TRUE : 0;
                        } /*break;*/
                    /*case*/ else if(attr == ReflectUtils.getInternalInt("com.android.internal.R$styleable", "RelativeLayout_Layout_layout_centerVertical")
                    /*com.android.internal.R.styleable.RelativeLayout_Layout_layout_centerVertical:*/){
                        rules[CENTER_VERTICAL] = a.getBoolean(attr, false) ? TRUE : 0;
                       } /*break;*/
                    /*case*/ else if(attr == ReflectUtils.getInternalInt("com.android.internal.R$styleable", "RelativeLayout_Layout_layout_toStartOf")
                    /*com.android.internal.R.styleable.RelativeLayout_Layout_layout_toStartOf:*/){
                        rules[START_OF] = a.getResourceId(attr, 0);
                        } /*break;*/
                    /*case*/ else if(attr == ReflectUtils.getInternalInt("com.android.internal.R$styleable", "RelativeLayout_Layout_layout_toEndOf")
                    /*com.android.internal.R.styleable.RelativeLayout_Layout_layout_toEndOf:*/){
                        rules[END_OF] = a.getResourceId(attr, 0);
                        } /*break;*/
                    /*case*/ else if(attr == ReflectUtils.getInternalInt("com.android.internal.R$styleable", "RelativeLayout_Layout_layout_alignStart")
                    /*com.android.internal.R.styleable.RelativeLayout_Layout_layout_alignStart:*/){
                        rules[ALIGN_START] = a.getResourceId(attr, 0);
                        } /*break;*/
                    /*case*/ else if(attr == ReflectUtils.getInternalInt("com.android.internal.R$styleable", "RelativeLayout_Layout_layout_alignEnd")
                    /*com.android.internal.R.styleable.RelativeLayout_Layout_layout_alignEnd:*/){
                        rules[ALIGN_END] = a.getResourceId(attr, 0);
                        } /*break;*/
                    /*case*/ else if(attr == ReflectUtils.getInternalInt("com.android.internal.R$styleable", "RelativeLayout_Layout_layout_alignParentStart")
                    /*com.android.internal.R.styleable.RelativeLayout_Layout_layout_alignParentStart:*/){
                        rules[ALIGN_PARENT_START] = a.getBoolean(attr, false) ? TRUE : 0;
                        } /*break;*/
                    /*case*/ else if(attr == ReflectUtils.getInternalInt("com.android.internal.R$styleable", "RelativeLayout_Layout_layout_alignParentEnd")
                    /*com.android.internal.R.styleable.RelativeLayout_Layout_layout_alignParentEnd:*/){
        ...
        public String debug(String output) {
            return output + "ViewGroup.LayoutParams={ width=" + width +
                    ", height=" + height + " }";
        }
        ...
        public void resolveLayoutDirection(int layoutDirection) {
            final boolean isLayoutRtl = RelativeLayout.isLayoutRtl;
            if (isLayoutRtl) {
                if (mStart != Integer.MIN_VALUE) mRight = mStart;
                if (mEnd != Integer.MIN_VALUE) mLeft = mEnd;
            } else {
                if (mStart != Integer.MIN_VALUE) mLeft = mStart;
                if (mEnd != Integer.MIN_VALUE) mRight = mEnd;
            }
