...
public class RoundCornerImageView extends ImageView {
  ...
  public RoundCornerImageView(Context context, AttributeSet attrs, int defStyle) {
    ...
    TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.RoundCornerImageViewAttr, defStyle, 0);

    int index = a.getInt(R.styleable.RoundCornerImageViewAttr_android_scaleType, -1);
    if (index >= 0) {
    ...
    cornerRadius = a.getDimensionPixelSize(R.styleable.RoundCornerImageViewAttr_corner_radius, -1);
    borderWidth = a.getDimensionPixelSize(R.styleable.RoundCornerImageViewAttr_border_width, -1);
    ...
    borderColor = a.getColorStateList(R.styleable.RoundCornerImageViewAttr_border_color);
    if (borderColor == null) {
      borderColor = ColorStateList.valueOf(RoundedDrawable.DEFAULT_BORDER_COLOR);
    }

    mutateBackground = a.getBoolean(R.styleable.RoundCornerImageViewAttr_mutate_background, false);
    isOval = a.getBoolean(R.styleable.RoundCornerImageViewAttr_oval, false);
