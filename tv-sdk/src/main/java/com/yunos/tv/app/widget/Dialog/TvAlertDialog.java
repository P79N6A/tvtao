 ...
 * </pre>
 * 
 * <p>The TvAlertDialog class takes care of automatically setting
...
public class TvAlertDialog extends Dialog implements DialogInterface {
    ...
    private int mFrostedGlassRadius = 5;
    /**
     * Special theme constant for {@link #TvAlertDialog(Context, int)}: use
    ...
    /**
     * System update style, UI 3.0 version added
     * */
    ...
    /**
     * Construct an TvAlertDialog that uses an explicit theme.  The actual style
     * that an TvAlertDialog uses is a private implementation, however you can
...
//    TvAlertDialog(Context context, int theme, boolean createContextWrapper) {
//        super(context, resolveDialogTheme(context, theme), createContextWrapper);
////        mWindow.alwaysReadCloseOnTouchAttr(); // TODO by leiming.yanlm
//        mAlert = new AlertController(getContext(), this, getWindow());
//    }
//
//    protected TvAlertDialog(Context context, boolean cancelable, OnCancelListener cancelListener) {
...
//            return R.style.AlertDialog_Ali_TV_THEME/*android.R.style.Theme_Dialog_Alert*/;
//        } else if (resid == THEME_HOLO_DARK) {
//            return R.style.AlertDialog_Ali_TV_THEME/*R.style.Theme_Holo_Dialog_Alert*/;
//        } else if (resid == THEME_HOLO_LIGHT) {
//            return R.style.AlertDialog_Ali_TV_THEME/*R.style.Theme_Holo_Light_Dialog_Alert*/;
//        } else if (resid == THEME_DEVICE_DEFAULT_DARK) {
//            return R.style.AlertDialog_Ali_TV_THEME/*R.style.Theme_DeviceDefault_Dialog_Alert*/;
//        } else if (resid == THEME_DEVICE_DEFAULT_LIGHT) {
//            return R.style.AlertDialog_Ali_TV_THEME/*R.style.Theme_DeviceDefault_Light_Dialog_Alert*/;
...
//        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(mNeedFrostedGlass){
	        MessageHandler msgHandler = MessageHandler.getInstance();
	        if(mNeedFrostedGlassBmp != null){
	        	msgHandler.getHandler().postDelayed(new Runnable() {
					@Override
					public void run() {
						FrostedGlass fg = new FrostedGlass();
						fg.stackBlur(mNeedFrostedGlassBmp, mFrostedGlassRadius);
						handler.post(new Runnable() {
							@Override
							public void run() {
								mAlert.setBackground(mNeedFrostedGlassBmp);
							}
						});
					}
				}, 200);
...
//	        	final Bitmap screenBmp = FrostedGlass.getScreenShot(getContext(), 4.0f);
//	        	if(screenBmp != null){
//		        	msgHandler.getHandler().postDelayed(new Runnable() {
//						@Override
//						public void run() {
//							FrostedGlass fg = new FrostedGlass();
//							fg.stackBlur(screenBmp, mFrostedGlassRadius);
//							handler.post(new Runnable() {
//								@Override
//								public void run() {
//									Log.i(TAG, "onFronstedGlassSreenDone bmp="+screenBmp);
//									mAlert.setBackground(screenBmp);
//								}
//							});
//						}
//					}, 200);
//	        	}
	        	...
	        	msgHandler.getHandler().postDelayed(new Runnable() {
					...
					public void run() {
						FrostedGlass fg = new FrostedGlass();
						//getFrostedGlassBitmp包括截屏+毛玻璃效果，模糊程度为5，bitmap图片质量为320X180
						final Bitmap screenBmp = fg.getFrostedGlassBitmap(getContext());
						if (screenBmp == null) {
							Log.e(TAG, "getFrostedGlassBitmap  screenBmp is null!");
							return ;
						}
						handler.post(new Runnable() {
							@Override
    ...
    public static class Builder {
        ...
        /**
         * Constructor using a context for this builder and the {@link TvAlertDialog} it creates.
         */
         ...
         * the {@link TvAlertDialog} it creates.  The actual theme
         * that an TvAlertDialog uses is a private implementation, however you can
         * here supply either the name of an attribute in the theme from which
         * to get the dialog's style (such as {@link android.R.attr#alertDialogTheme}
         * or one of the constants
         * {@link TvAlertDialog#THEME_TRADITIONAL TvAlertDialog.THEME_TRADITIONAL},
         * {@link TvAlertDialog#THEME_HOLO_DARK TvAlertDialog.THEME_HOLO_DARK}, or
         * {@link TvAlertDialog#THEME_HOLO_LIGHT TvAlertDialog.THEME_HOLO_LIGHT}.
         */
        ...
        private boolean mNeedFrostedGlass = false;
        private int mFrostedGlassRadius = 5;
        private Bitmap mNeedFrostedGlassBmp;
        ...
        public Builder setCustomerButtons(CharSequence[] texts, final OnClickListener listener) {
            P.mCustomItems = texts;
            P.mCustomItemClickListener = listener;
            return this;
        }
        ...
        /**
         * Creates a {@link TvAlertDialog} with the arguments supplied to this builder. It does not
         * {@link Dialog#show()} the dialog. This allows the user to do any extra processing
         * before displaying the dialog. Use {@link #show()} if you don't have any other processing
         * to do and want this to be created and displayed.
         */
        public TvAlertDialog create() {
            final TvAlertDialog dialog = new TvAlertDialog(P.mContext, mTheme);
        ...
        /**
         * Creates a {@link TvAlertDialog} with the arguments supplied to this builder and
        ...
        /**
         * Check whether need dialog Entry Animation.
         * */
		public boolean needEntryAnimation() {
			if (mTheme == R.style.Theme_Ali_TV_Dialog_Alert_SysUpdate
					|| mTheme == R.style.Theme_Ali_TV_Dialog_Alert_SetNetwork) {
				return true;
			} else {
				return false;
			}
