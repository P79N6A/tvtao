...
public class FocusFinder {
	...
	boolean isBetterCandidate(int direction, Rect source, Rect rect1, Rect rect2) {
		...
		return (getWeightedDistanceFor(majorAxisDistance(direction, source, rect1), minorAxisDistance(direction, source, rect1)) < getWeightedDistanceFor(majorAxisDistance(direction, source, rect2),
	...
	float getWeightedDistanceFor(int majorAxisDistance, int minorAxisDistance) {
		...
		return (13 * floatAxisDistance * floatAxisDistance + floatMinorAxisDistance * floatMinorAxisDistance);
	}
	...
	boolean isCandidate(Rect srcRect, Rect destRect, int direction) {
		...
		case View.FOCUS_FORWARD:
			return (srcRect.right > destRect.right || srcRect.left >= destRect.right)
					...
					&& (srcRect.top <= destRect.top && srcRect.bottom >= destRect.top || srcRect.top <= destRect.bottom && srcRect.bottom >= destRect.bottom || srcRect.top >= destRect.top
		...
		case View.FOCUS_UP:
			return (srcRect.bottom > destRect.bottom || srcRect.top >= destRect.bottom)
					...
					&& (srcRect.left <= destRect.left && srcRect.right >= destRect.left || srcRect.left <= destRect.right && srcRect.right >= destRect.right || srcRect.left >= destRect.left
							&& srcRect.right <= destRect.right);
		case View.FOCUS_DOWN:
