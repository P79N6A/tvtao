...
public class FrameLayout extends ViewGroup {
    ...
    public FrameLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, ReflectUtils.getInternalIntArray("com.android.internal.R$styleable", "FrameLayout")
        		/*com.android.internal.R.styleable.FrameLayout*/,
                    defStyle, 0);

        mForegroundGravity = a.getInt(ReflectUtils.getInternalInt("com.android.internal.R$styleable", "FrameLayout_foregroundGravity")
                /*com.android.internal.R.styleable.FrameLayout_foregroundGravity*/, mForegroundGravity);

        final Drawable d = a.getDrawable(ReflectUtils.getInternalInt("com.android.internal.R$styleable", "FrameLayout_foreground")
        		/*com.android.internal.R.styleable.FrameLayout_foreground*/);
        if (d != null) {
            setForeground(d);
        }

        if (a.getBoolean(ReflectUtils.getInternalInt("com.android.internal.R$styleable", "FrameLayout_measureAllChildren")
        		/*com.android.internal.R.styleable.FrameLayout_measureAllChildren*/, false)) {
            setMeasureAllChildren(true);
        }

        mForegroundInPadding = a.getBoolean(ReflectUtils.getInternalInt("com.android.internal.R$styleable", "FrameLayout_foregroundInsidePadding")
    ...
    public boolean gatherTransparentRegion(Region region) {
        ...
        if (region != null && mForeground != null) {
            applyDrawableToTransparentRegionByReflect(mForeground, region);
        }
        return opaque;
    }
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            ...
            gravity = a.getInt(ReflectUtils.getInternalInt("com.android.internal.R$styleable", "FrameLayout_Layout_layout_gravity")
            		/*com.android.internal.R.styleable.FrameLayout_Layout_layout_gravity*/, -1);
            a.recycle();
        }
