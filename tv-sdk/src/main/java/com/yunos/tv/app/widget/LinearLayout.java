...
public class LinearLayout extends ViewGroup {
    ...
    public LinearLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, ReflectUtils.getInternalIntArray("com.android.internal.R$styleable", "LinearLayout")
                /*com.android.internal.R.styleable.LinearLayout*/, defStyle, 0);

        int index = a.getInt(ReflectUtils.getInternalInt("com.android.internal.R$styleable", "LinearLayout_orientation")
        		/*com.android.internal.R.styleable.LinearLayout_orientation*/, -1);
        if (index >= 0) {
            setOrientation(index);
        }

        index = a.getInt(ReflectUtils.getInternalInt("com.android.internal.R$styleable", "LinearLayout_gravity")
        		/*com.android.internal.R.styleable.LinearLayout_gravity*/, -1);
        if (index >= 0) {
            setGravity(index);
        }

        boolean baselineAligned = a.getBoolean(ReflectUtils.getInternalInt("com.android.internal.R$styleable", "LinearLayout_baselineAligned")
        		/*R.styleable.LinearLayout_baselineAligned*/, true);
        if (!baselineAligned) {
            setBaselineAligned(baselineAligned);
        }

        mWeightSum = a.getFloat(ReflectUtils.getInternalInt("com.android.internal.R$styleable", "LinearLayout_weightSum")
        		/*R.styleable.LinearLayout_weightSum*/, -1.0f);

        mBaselineAlignedChildIndex =
                a.getInt(ReflectUtils.getInternalInt("com.android.internal.R$styleable", "LinearLayout_baselineAlignedChildIndex")
                		/*com.android.internal.R.styleable.LinearLayout_baselineAlignedChildIndex*/, -1);

        mUseLargestChild = a.getBoolean(ReflectUtils.getInternalInt("com.android.internal.R$styleable", "LinearLayout_measureWithLargestChild")
        		/*R.styleable.LinearLayout_measureWithLargestChild*/, false);

        setDividerDrawable(a.getDrawable(ReflectUtils.getInternalInt("com.android.internal.R$styleable", "LinearLayout_divider")
        		/*R.styleable.LinearLayout_divider*/));
        mShowDividers = a.getInt(ReflectUtils.getInternalInt("com.android.internal.R$styleable", "LinearLayout_showDividers")
        		/*R.styleable.LinearLayout_showDividers*/, SHOW_DIVIDER_NONE);
        mDividerPadding = a.getDimensionPixelSize(ReflectUtils.getInternalInt("com.android.internal.R$styleable", "LinearLayout_dividerPadding")
    ...
    void drawDividersHorizontal(Canvas canvas) {
        final int count = getVirtualChildCount();
        final boolean isLayoutRtl = isLayoutRtlByReflect();
        for (int i = 0; i < count; i++) {
            final View child = getVirtualChildAt(i);
     ...
     * {@link com.yunos.tv.app.widget.ViewGroup.LayoutParams#MATCH_PARENT}
     * and a height of {@link com.yunos.tv.app.widget.ViewGroup.LayoutParams#WRAP_CONTENT}
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        public LayoutParams(Context c, AttributeSet attrs) {
            super(c, attrs);
            TypedArray a =
                    c.obtainStyledAttributes(ReflectUtils.getInternalIntArray("com.android.internal.R$styleable", "LinearLayout_Layout")
                    		/*com.android.internal.R.styleable.LinearLayout_Layout*/);

            weight = a.getFloat(ReflectUtils.getInternalInt("com.android.internal.R$styleable", "LinearLayout_Layout_layout_weight")
            		/*com.android.internal.R.styleable.LinearLayout_Layout_layout_weight*/, 0);
            gravity = a.getInt(ReflectUtils.getInternalInt("com.android.internal.R$styleable", "LinearLayout_Layout_layout_gravity")
        ...
        public String debug(String output) {
            return output + "LinearLayout.LayoutParams={width=" + width +
