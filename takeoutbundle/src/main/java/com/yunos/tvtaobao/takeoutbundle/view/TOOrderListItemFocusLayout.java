 ...
 * @author tingmeng.ytm
 */
public class TOOrderListItemFocusLayout extends InnerFocusLayout {
    ...
    public TOOrderListItemFocusLayout(Context context) {
        super(context);
        init();
    }

    public TOOrderListItemFocusLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public TOOrderListItemFocusLayout(Context context, AttributeSet attrs, int defStyle) {
    ...
    public FocusRectParams getFocusParams() {
        ...
        r.right -= getResources().getDimensionPixelSize(R.dimen.dp_10);
        r.bottom -= getResources().getDimensionPixelSize(R.dimen.dp_10);
