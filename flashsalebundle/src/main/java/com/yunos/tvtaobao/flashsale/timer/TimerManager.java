package com.yunos.tvtaobao.flashsale.timer;
...
//		startAlarmReminderCheck();
     ...
     * 当前需要定时
     */
    private MyconcernInfo mCurMyconcernInfo;
    ...
    private void startAlarmReminder(final MyconcernInfo info) {
    ...
    public void onReminder(Context context, MyconcernInfo info) {
        //去掉提醒服务
//		Intent it = new Intent(TimerManager.ACTION_ALARM_REMINDER);
//		
//		it.setClass(mAppContext, ReminderService.class);
...
//		context.startService(it);
    ...
    public void startNextAlarm(long curTime, MyconcernInfo curInfo) {
