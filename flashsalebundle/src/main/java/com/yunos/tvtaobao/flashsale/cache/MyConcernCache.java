 ...
 * 2015-4-19       lizhi.ywp
 */
package com.yunos.tvtaobao.flashsale.cache;
...
import com.yunos.tvtaobao.flashsale.databases.MyConcernProvider;
...
public class MyConcernCache {
    ...
    public void autoClear() {
        /** cache data */
        final long zeroTime = DateUtils.getTimeAtZero(mContext);
