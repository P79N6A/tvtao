...
//                Log.i("LimitedDiscCache", "mostLongUsedFile = " + mostLongUsedFile);
            }
        }
        ...
        if (mostLongUsedFile != null) { 
            exists = mostLongUsedFile.exists();
            if (exists) {
                fileSize = getSize(mostLongUsedFile);
                delete = mostLongUsedFile.delete();
                if (delete) {
...
//        Log.i("LimitedDiscCache", "mostLongUsedFile = " + mostLongUsedFile + "; delete = " + delete + "; exists = " + exists + "; fileSize = " + fileSize);
