...
import com.tvlife.imageloader.cache.memory.impl.FuzzyKeyMemoryCache;
...
public final class ImageLoaderConfiguration {
    ...
    public static class Builder {
         ...
         * @param processorForDiscCache null-ok; {@linkplain BitmapProcessor Bitmap processor} which process images
         *            before saving them in disc cache
         */
        public Builder discCacheExtraOptions(int maxImageWidthForDiscCache, int maxImageHeightForDiscCache,
                CompressFormat compressFormat, int compressQuality, BitmapProcessor processorForDiscCache) {
        ...
        // Cache缓冲 文件名 
        public Builder discCacheFileFileName(String filename) {
         ...
         * Consider {@link com.nostra13.universalimageloader.utils.L#disableLogging()} to disable ImageLoader logging
        ...
        private void initEmptyFieldsWithDefaultValues() {
            ...
            if (discCache == null) {
                ...
                discCache = DefaultConfigurationFactory.createDiscCache(context, discCacheFileNameGenerator,
                        discCacheSize, discCacheFileCount, filename);
            }
            if (memoryCache == null) {
    ...
    Resources getResources() {
        return contextWeakReference == null || contextWeakReference.get() == null ? null : contextWeakReference.get().getResources();
    }
}
