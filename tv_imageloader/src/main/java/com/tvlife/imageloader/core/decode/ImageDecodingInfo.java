...
public class ImageDecodingInfo {
    ...
    public ImageDecodingInfo(String imageKey, String imageUri, String filename, ImageSize targetSize,
            ImageLoaderEngine engine, ViewScaleType viewScaleType, ImageDownloader downloader,
        ...
        isHaveDecodeSample = displayOptions.isDecodeSample();

        bitmapPath = displayOptions.getBitmapPath();
        bitmapName = filename;
    ...
    /**
     * @return Original
     *         {@linkplain com.nostra13.universalimageloader.utils.MemoryCacheUtils#generateKey(String, ImageSize) image
    ...
    public boolean cancelLoadIfneed() {
        ...
        boolean result = !engine.loadIfNeed(imageKey);  
        return result;
    }
}