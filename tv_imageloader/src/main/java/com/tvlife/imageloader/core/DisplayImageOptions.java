 ...
 * <li>whether {@link com.nostra13.universalimageloader.core.imageaware.ImageAware image
 * aware view} should be reset
 ...
 * <b>i.e.</b> :
 * <code>new {@link DisplayImageOptions}.{@link Builder#Builder() Builder()}. {@link Builder#cacheInMemory()
 * cacheInMemory()}. {@link Builder#showImageOnLoading(int) showImageOnLoading()}. {@link Builder#build() build()}
 * </code><br />
 * </li>
...
public final class DisplayImageOptions {
    ...
    private DisplayImageOptions(Builder builder) {
        ...
        isdisplayShow = builder.isdisplayShow;
        bitmapPath = builder.bitmapPath;
        isHaveDecodeSample = builder.isHaveDecodeSample;
    }
    ...
    public static class Builder {
        ...
        private boolean isdisplayShow = true;
        private String bitmapPath;
        ...
        private boolean isHaveDecodeSample = true;
         ...
         * string) will be passed to <b>ImageLoader.displayImage(...)</b>
         * method.
         * @param imageRes
         *            Image resource
         */
         ...
         * parameter is used while define scale
         ...
         * be cached in memory. So memory cache
        ...
        /**
         * Sets bitmap processor which will be process bitmaps before they will
         * be displayed in {@link com.nostra13.universalimageloader.core.imageaware.ImageAware
         ...
         * Default value - {@link DefaultConfigurationFactory#createBitmapDisplayer()}
         */
         ...
         * firing {@linkplain ImageLoadingListener
         * listener} events.
         */
        ...
        public Builder cloneFrom(DisplayImageOptions options) {
            ...
            isdisplayShow = options.isdisplayShow;
            bitmapPath = options.bitmapPath;
