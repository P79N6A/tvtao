...
import com.tvlife.imageloader.utils.MemoryCacheUtils;
...
public class ImageLoader {
    ...
    public static ImageLoader getInstance() {
        L.i("getInstance --> instance = " + instance);
        if (instance == null) {
     ...
     *                   process. Listener fires events on
     ...
     *                   Options} for image
     *                   decoding and displaying. If <b>null</b> - default display
     *                   image options
     ...
     * @throws IllegalArgumentException if passed <b>imageAware</b> is null
     */
    public void displayImage(String uri, String bitmapname, ImageAware imageAware, DisplayImageOptions options,
        ...
        // 用 图片的URL 作为 KEY， 跟 显示的目标大小无关 @by yunzhong.qyz
        ...
        if (options.isCacheInMemory()) {
            //  从Memory中取， 一般如果设置为缓冲到Memory中的，那也认为也从缓冲取
        ...
        if (bmp != null && !bmp.isRecycled()) {
            ...
            //                }
            //            } else {
            //                options.getDisplayer().display(bmp, imageAware, LoadedFrom.MEMORY_CACHE, configuration.writeLogs);
            ...
            ImageLoadingInfo imageLoadingInfo = new ImageLoadingInfo(uri, bitmapname, imageAware, targetSize,
    ...
    public void displayImage(String uri, ImageView imageView, DisplayImageOptions options) {
        displayImage(uri, null, new ImageViewAware(imageView), options, null, null);
    }
    ...
    public void displayImage(String uri, ImageView imageView, ImageLoadingListener listener) {
        displayImage(uri, null, new ImageViewAware(imageView), null, listener, null);
    }
    ...
    public void displayImage(String uri, ImageView imageView, DisplayImageOptions options,
                             ImageLoadingListener listener, ImageLoadingProgressListener progressListener) {
        displayImage(uri, null, new ImageViewAware(imageView), options, listener, progressListener);
    }
     ...
     *                 "file:///mnt/sdcard/image.png")
     * @param listener {@linkplain ImageLoadingListener Listener} for image loading
     *                 process. Listener fires events on UI
     *                 thread if this method is called on UI thread.
     * @throws IllegalStateException if {@link #init(ImageLoaderConfiguration)} method wasn't
     *                               called before
     */
    public void loadImage(String uri, ImageLoadingListener listener) {
        loadImage(uri, null, null, null, listener, null);
    }
    ...
    public void loadImage(String uri, ImageSize targetImageSize, ImageLoadingListener listener) {
        loadImage(uri, null, targetImageSize, null, listener, null);
    }
    ...
    public void loadImage(String uri, ImageSize targetImageSize, DisplayImageOptions options,
                          ImageLoadingListener listener) {
        loadImage(uri, null, targetImageSize, options, listener, null);
    }
     ...
     *                               called before
     */
    public void loadImage(String uri, String bitmapname, ImageSize targetImageSize, DisplayImageOptions options,
                          ImageLoadingListener listener, ImageLoadingProgressListener progressListener) {
        checkConfiguration();
        ...
        displayImage(uri, bitmapname, imageAware, options, listener, progressListener);
    }
     ...
     * @param options {@linkplain com.nostra13.universalimageloader.core.DisplayImageOptions
     *                Options} for image
     *                decoding and scaling. If <b>null</b> - default display image
     *                options {@linkplain ImageLoaderConfiguration.Builder#defaultDisplayImageOptions(DisplayImageOptions)
     *                from
     ...
     *
     * @param imageView {@link android.widget.ImageView ImageView} for which display
    ...
    public void cancelLoadAllTaskFor() {
        L.i("ImageLoader:  cancelLoadAllTaskFor -->");
        engine.cancelLoadAllTaskFor();
    }

    // 测试
    public void setTestBitmap(Bitmap bm) {
        engine.setTestBitmap(bm);
    }
     ...
     * ImageLoader is {@link #resume() resumed}.
     * <br />
     ...
     * with new configuration after calling this
     * method.
     */
    public void destroy() {
