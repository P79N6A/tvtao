...
//import com.yunos.tvtaobao.asr.sutils.ASRUtils;
...
//        HomeVideoViewController.isError = false;
...
//        mTMallLiveListBean = mLiveDataController.getTMallLiveListBean();
//
...
//        ASRUtils.getInstance().setHandler(new ASRUtils.ASRHANDLER() {
//            @Override
...
//        loadingDR = Tools.getBitmapDrawable(this, R.drawable.tmall_live_loading_img);
...
//
//                } else {
//                    mBusinessRequest.getTMallLiveList(new GetTMallLiveListListener(new WeakReference<BaseActivity>(TMallLiveActivity.this)));
//                }
//                return false;
//            }
//        });
...
//        HomeVideoViewController.tmallLiveError = false;
//    }
//
//    /**
//     * 插入评论视图
...
//        mBusinessRequest.getTMallLiveDetail(liveId, new GetTMallDetailListener(new WeakReference<BaseActivity>(this)));
//    }
//
//    /**
//     * 淡出消失动画
...
//        mBusinessRequest.getTMallLiveComment("tlive", sourceId, 2, -1, "0", "0", 30, false, new GetTMallCommentListener(new WeakReference<BaseActivity>(this)));
//    }
//
//    /**
//     * 发送评论
...
//        AppHolder appHolder = (AppHolder) getApplicationContext();
...
//
//            mBusinessRequest.sendComment(cid, "0", text, "hot", "0", "0", new SendCommentListener(new WeakReference<BaseActivity>(this)));
//        }
//    }
//
//    /**
...
//
//        Bitmap qrBitmap = getQrCodeBitmap(accountUrl, icon);
//
...
//                mLiveDataController.setCurrentTMallLivePos(0);
//                mLiveDataController.setTMallItemsBean(data.get(0));
//            } else {
//                tmall_live_loading_img.setVisibility(View.VISIBLE);
//                tmall_live_loading_img.setBackgroundColor(0x99000000);
...
//                tmall_live_shop_log.setImageResource(R.drawable.tmall_icon);
//                iv_shop.clearFocus();
//            }
//
//            @Override
...
//            @Override
//            public void onAnimationEnd(Animation animation) {
//                mBusinessRequest.getTMallLiveShop("tlive", cid, -1, 50, new GetTMallShopListener(new WeakReference<BaseActivity>(TMallLiveActivity.this)));
//
...
//        mLiveDataController.setTMallItemsBean(itemsBean);
//        mLiveDataController.setCurrentTMallLivePos(currentPos);
//    }
//
//    /**
//     * 关闭商品列表
