...
import com.taobao.detail.clientDomain.TBDetailResultVO.ItemInfoModel;
...
//        if (extras != null) {
//            resolve_Extras(tbDetailResultVO, extras);
//        }
    ...
    private static void resolve_ApiStack(TBDetailResultVO tbDetailResultVO, JSONArray array) {
        ...
        tbDetailResultVO.apiStack = new ArrayList<Unit>();
