...
public class ItemMO implements Serializable {
    ...
    public String toString() {
        return "ItemMO [itemId=" + itemId + ", longName=" + longName + ", shortName=" + shortName + ", itemUrl=" + itemUrl + ", itemCount="
                + itemCount + ", parentCategory=" + parentCategory + ", childCategory=" + childCategory + ", shopType=" + shopType + ", payPostage="
                + payPostage + ", originalPrice=" + originalPrice + ", picUrl=" + picUrl + ", picWideUrl=" + picWideUrl + ", picWideBytes="
                + Arrays.toString(picWideBytes) + ", activityPrice=" + activityPrice + ", city=" + city + ", itemDesc=" + itemDesc + ", itemStatus="
                + itemStatus + ", itemGuarantee=" + itemGuarantee + ", discount=" + discount + ", checkComment=" + checkComment + ", platformId="
                + platformId + ", groupId=" + groupId + ", sellerId=" + sellerId + ", sellerNick=" + sellerNick + ", sellerCredit=" + sellerCredit
                + ", categoryId=" + categoryId + ", soldCount=" + soldCount + ", gmtCreate=" + gmtCreate + ", gmtModified=" + gmtModified
                + ", limitNum=" + limitNum + ", isLock=" + isLock + ", onlineStartTime=" + onlineStartTime + ", onlineEndTime=" + onlineEndTime
                + ", key=" + key + ", imageLabel=" + imageLabel + ", preOnline=" + preOnline + ", pushName=" + pushName + ", attributes="
                + attributes + "]";
    }
